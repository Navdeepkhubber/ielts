...
def _get_ocr():
    ...
    # Explicitly select the lightweight PP-OCRv5 mobile detector. PaddleOCR
    # otherwise defaults to the server detector, which is unnecessarily heavy
    # for local M1/16 GB development and can cause large native allocations.
    _OCR = PaddleOCR(
        lang="en",
